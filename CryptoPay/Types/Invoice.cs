...
namespace CryptoPay.Types {
	...
	public sealed class Invoice : IInvoice {
		...
		///     Hash of the invoice.
		/// </summary>
		[JsonRequired, JsonPropertyName("hash")]
		...
		/// </summary>
		[Obsolete("The field Fee in the Webhook update payload is now deprecated, use the new field FeeAmount instead"), JsonPropertyName("fee")]
